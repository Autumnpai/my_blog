...
def blog(request, blog_id):
    ...
    _check_blog_owner(blog, request.user)
    posts = blog.post_set.order_by('-date_added')
    # ".post_set" is generated by django regarding the Post class.
...
def _check_blog_owner(blog, user):
    """Make sure the user associated with a blog."""
    if blog.owner != user:
        raise Http404